...
public class Strings
{
    ...
    public static String subscript(String value)
    {
        ...
        for (char character : value.toCharArray()) {
            if (ScriptValue.BY_CHAR.containsKey(character)) {
                builder.append(ScriptValue.BY_CHAR.get(character).sub());
            }
        }
    ...
    public static String superscript(String value)
    {
        ...
        for (char character : value.toCharArray()) {
            if (ScriptValue.BY_CHAR.containsKey(character)) {
                builder.append(ScriptValue.BY_CHAR.get(character).sup());
            }
        }
    ...
    {
        if (!string.contains(".")) {
            PeripheralExceptionThread.invoke(new RuntimeException("String '%s' does not seem to contain an extension"));
        }
